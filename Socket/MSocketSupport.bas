...
'********************************************************************************
'This module contains API declarations and helper functions for the LhSocket class
'********************************************************************************
'Version: 1.0.12     Modified: 17-OCT-2002
'********************************************************************************
'To get latest version of this code please visit the following web page:
'http://www.vbip.com/winsock-api/LhSocket-class/LhSocket-class-01.asp
'********************************************************************************
...
'visible from the LhSocket class module
...
Private Function WindowProc(ByVal hwnd As Long, ByVal uMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
    ...
    'reference to the instance of the LhSocket class and calls
    'either the PostSocketEvent or PostGetHostEvent method of the
    'class to pass that message to the class.
    '
    Dim objSocket           As LhSocket  'the illegal reference to an
                                        'instance of the LhSocket class
    Dim lngObjPointer       As Long     'pointer to the existing instance
                                        'of the LhSocket class
    ...
    If uMsg = p_lngWinsockMessage Then  'Modified: 04-MAR-2002
        '
        'All the pointers to the existing instances of the LhSocket class
        ...
        'instance of the LhSocket class. Since the wParam argument of the
        ...
        '
        'Forward the message to the instance of the LhSocket class
    ...
    ElseIf uMsg = m_lngResolveMessage Then  'Modified: 04-MAR-2002
        ...
        'instance of the LhSocket class. So, if we know a value
        ...
        '
        'A value of the pointer to the instance of the LhSocket class
        ...
        'pointer to the instance of the LhSocket class.
...
ERORR_HANDLER:
    '
    'Err.Raise Err.Number, "LhSocket.WindowProc", Err.Description
    '
    'GoTo EXIT_LABEL
    '
End Function
...
'           lngObjectPointer - pointer to an object, instance of the LhSocket class
...
'********************************************************************************
    ...
    'is the pointer to the instance of the LhSocket class.
...
'Author    :Oleg Gdalevich
'Date/Time :17-12-2001
'Purpose   :Receives requests to resolve a host address from the LhSocket class.
...
'********************************************************************************
    ...
    'LhSocket class, this function can be called to start several
    ...
    'the instance of the LhSocket class and the item's data is the
    'Request ID, the value returned by the WSAAsyncGetHostByXXXX
    'Winsock API function. So in order to get the pointer to the
    'instance of the LhSocket class by the task ID value the following
    ...
    'pointer to the instance of LhSocket class we can use the following code:
    '
    'lngMemoryHandle = CLng(m_colMemoryBlocks("S" & lngObjPointer))
    '
    ...
    '   - which instance of the LhSocket class we need to post the info to
    '
...
Private Function SocketObjectFromPointer(ByVal lngPointer As Long) As LhSocket
    '
    Dim objSocket As LhSocket
    '
...
Public Function InitWinsockService() As Long
    ...
    Else
        ...
        'instance of the LhSocket class, the code to init the
...
'procedure of any instance of the LhSocket class. But the WSACleanup
'Winsock API function is called only if the calling object is the
'last instance of the LhSocket class within the current process.
'********************************************************************************
    '
